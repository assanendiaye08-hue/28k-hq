 ...
 * in the result.
 *
 * The master encryption key is read directly from process.env.MASTER_ENCRYPTION_KEY.
 */
...
/**
 * Get the master encryption key as a Buffer from process.env.
 * Validates the key format: must be a 64-character hex string (32 bytes).
 */
